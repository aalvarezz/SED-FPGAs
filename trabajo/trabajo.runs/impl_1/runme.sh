...
HD_PWD='C:/Archivos/SED/trabajo/trabajo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_entity.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_entity.tcl -notrace
